...
def main():
    for run in range(1, num_runs + 1):
        ...
        if do_train:
            ...
            train_input_sentences, train_target_sentences = prepare_data_with_noise(train_dataset)
            val_input_sentences, val_target_sentences = prepare_data_with_noise(val_dataset)
